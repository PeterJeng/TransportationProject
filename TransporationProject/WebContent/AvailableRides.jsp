...
%>
<h2 align="center"><font><strong>Available Rides By Destination</strong></font></h2>
...
String sql ="SELECT * FROM OfferRide WHERE destination = '" + destinationn + "'";
...
<td><%=resultSet.getString("additionalinformation") %></td>
...
<center>
    ...
    <form method = "post" action = "DeleteOfferRides">
